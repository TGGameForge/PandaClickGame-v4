...
exports.generateAuthTokenFromCognitoEmailOtp = generateAuthTokenFromCognitoEmailOtp;
exports.sendUserManagedEmailOtp = sendUserManagedEmailOtp;
exports.validateUserManagedEmailOtp = validateUserManagedEmailOtp;
exports.isValidUserManagedEmailOtp = isValidUserManagedEmailOtp;
...
const authFetchEmbeddedWalletUser = async (client, url, props) => {
    ...
    return (0, fetch_js_1.getClientFetch)(client)(url, params);
};
...
async function generateAuthTokenFromCognitoEmailOtp(session, clientId) {
    const resp = await fetch(constants_js_1.ROUTE_VERIFY_COGNITO_OTP, {
        method: "POST",
        headers: {
            ...getSessionHeaders(),
        },
...
async function sendUserManagedEmailOtp(email, clientId) {
    const resp = await fetch(constants_js_1.ROUTE_USER_MANAGED_OTP, {
        method: "POST",
        headers: {
            ...getSessionHeaders(),
        },
...
async function validateUserManagedEmailOtp(options) {
    const resp = await fetch(constants_js_1.ROUTE_VALIDATE_USER_MANAGED_OTP, {
        method: "POST",
        headers: {
            ...getSessionHeaders(),
        },
...
async function isValidUserManagedEmailOtp(options) {
    const resp = await fetch(constants_js_1.ROUTE_IS_VALID_USER_MANAGED_OTP, {
        method: "POST",
        headers: {
            ...getSessionHeaders(),
        },
