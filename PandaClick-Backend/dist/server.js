...
const vibe_1 = __importDefault(require("./routes/api/vibe"));
const walletAddress_1 = __importDefault(require("./routes/api/walletAddress"));
...
app.use("/api/walletAddress", walletAddress_1.default);
